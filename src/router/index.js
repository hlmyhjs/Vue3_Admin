...
export const constantRoutes = [
  ...
  },
  {
    ...
    name: 'TablePro',
    redirect: 'noRedirect',
    meta: { title: '表格组件', icon: 'build' },
    children: [
      {
        path: 'component',
        // 动态表格演示
        component: () => import('@/views/tablePro/index'),
        name: 'Component',
        meta: {
          title: '使用Component',
          icon: 'component',
          activeMenu: '/tablePro/component'
        }
      },
      {
        path: 'hook',
        component: () => import('@/views/tablePro/hook'),
        name: 'Hook',
        meta: {
          title: '使用Hooks',
          icon: 'component',
          activeMenu: '/tablePro/hook'
        }
      }
    ]
  },
